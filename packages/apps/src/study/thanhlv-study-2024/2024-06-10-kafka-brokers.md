...
date: 2024-06-10
outline: deep
image: $cdn/study/thanhlv-study-2024/2024-06-10-kafka-brokers/Leaders-and-followers.png
draft: false
group: 2.1 Kafka
---
...
![kafka-architecture-view.png]($cdn/study/thanhlv-study-2024/2024-06-10-kafka-brokers/kafka-architecture-view.png)
...
- Tất nhiên, Kafka Brokers cũng nhận và xử lý trực tiếp các request từ client.
  ![kafka-handler-request.jpg]($cdn/study/thanhlv-study-2024/2024-06-10-kafka-brokers/kafka-handler-request.jpg)
...
- Khi Produce muốn gửi Record đến Broker, Client Produce gửi records đến Broker đeer lưu trữ và consumer client có thể đọc các record đó sau.
  ![kafka-produce.jpg]($cdn/study/thanhlv-study-2024/2024-06-10-kafka-brokers/kafka-produce.jpg)
...
- Consumer client đưa ra yêu cầu đến Broker để đọc(Sử dụng) các Record từ một topic được các Produce gửi trước đó đên Broker.
  ![kafka-Consumer.jpg]($cdn/study/thanhlv-study-2024/2024-06-10-kafka-brokers/kafka-Consumer.jpg)
...
- Một topic đại diện cho tên của Folder chưa tệp Kafka nối thêm các Record
  ![kafka-topic-1.jpg]($cdn/study/thanhlv-study-2024/2024-06-10-kafka-brokers/kafka-topic-1.jpg)
...
- Kafka brokers gắn số partition và đuôi của folder topic với format `{Topic name}-{partition number}`.
  - Ví dụ một Topic tên `my-topic-2` có `5` partition thì tên sẽ như sau : `my-topic-2-0`, `my-topic-2-1`, `my-topic-2-2`, `my-topic-2-3`, , `my-topic-2-4`,
    ![kafka-partition-number.jpg]($cdn/study/thanhlv-study-2024/2024-06-10-kafka-brokers/kafka-partition-number.jpg)
```
│   ....
...
- Khi broker thêm một Record nó sẽ thêm một `id` được gọi là `offset`. Một `offset` sẽ bắt đầu từ `0` và là number, nó sẽ tặng lên 1 mỗi khi thêm một Record.
  ![kafka-offset.png]($cdn/study/thanhlv-study-2024/2024-06-10-kafka-brokers/kafka-offset.png)
...
![kafka-offset-2.png]($cdn/study/thanhlv-study-2024/2024-06-10-kafka-brokers/kafka-offset-2.png)
...
- Broker sẽ chia thành các tệp nhỏ thành các phần riêng biệt và được gọi là segments.
  ![kafka-partition-log-segments.png]($cdn/study/thanhlv-study-2024/2024-06-10-kafka-brokers/kafka-partition-log-segments.png)
  ![kafka-partition-log-segments-file.png]($cdn/study/thanhlv-study-2024/2024-06-10-kafka-brokers/kafka-partition-log-segments-file.png)
...
![retention-policy.png]($cdn/study/thanhlv-study-2024/2024-06-10-kafka-brokers/retention-policy.webp)
...
![Leaders-and-followers.png]($cdn/study/thanhlv-study-2024/2024-06-10-kafka-brokers/Leaders-and-followers.png)
...
![Replication.png]($cdn/study/thanhlv-study-2024/2024-06-10-kafka-brokers/Replication.png)

Tuy nhiên việc đồng bộ luôn sẽ có độ trễ. Nhìn minh họa dưới đây.

![Replication-lag.png]($cdn/study/thanhlv-study-2024/2024-06-10-kafka-brokers/Replication-lag.png)
...
- **Kafka book**: [Kafka Event Streaming Platform In Action.pdf]($cdn/study/thanhlv-study-2024/Kafka%20Event%20Streaming%20Platform%20In%20Action.pdf)
