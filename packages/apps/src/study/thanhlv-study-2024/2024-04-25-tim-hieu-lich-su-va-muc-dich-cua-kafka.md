...
## Kafka là gì ?
- Apache Kafka là một [Event stream platform](2024-04-21-event-stream-va-event-stream-platform-la-gi) được phát triển bởi [LinkedIn](https://www.linkedin.com/) và quyền góp cho apache và phát hành thành mã nguồn mở (Open-source) vào năm 2011.
