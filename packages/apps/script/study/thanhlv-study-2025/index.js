...
const PAGES_DIR = path.join(__dirname, '../../../src/study/thanhlv-study-2025')
...
function extractPagesData(dirPath) {
  ...
  files.forEach(file => {
    ...
    if (path.extname(file) === '.md') {
      ...
      link = '/study/thanhlv-study-2025' + link.replaceAll('\\', '/')
...
const pathExport = path.join(folderPath, 'thanhlv-study-2025-sidebar.json')
