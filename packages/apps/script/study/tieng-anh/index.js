...
const PAGES_DIR = path.join(__dirname, '../../../src/study/tieng-anh')
...
function extractPagesData(dirPath) {
  ...
  files.forEach(file => {
    ...
    if (path.extname(file) === '.md') {
      ...
      link = '/study/tieng-anh' + link.replaceAll('\\', '/')
...
const pathExport = path.join(folderPath, 'tieng-anh-sidebar.json')
